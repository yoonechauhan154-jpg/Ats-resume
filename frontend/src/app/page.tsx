      ...
      <section className="border-b border-[#D8D0C2]">
        <div className="container grid max-w-6xl items-center gap-12 px-4 py-12 md:grid-cols-[minmax(0,1fr)_minmax(360px,0.85fr)] md:px-6 md:py-20">
          <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="max-w-2xl">
            <Badge className="mb-6 border-[#2F7770]/40 bg-[#2F7770]/10 px-3 py-1 font-medium text-[#2F7770] hover:bg-[#2F7770]/10">
              <Sparkles className="mr-1 h-3 w-3 text-[#2F7770]" /> 100% free · No signup · Resume never stored
            </Badge>
          ...
          <div className="relative" aria-label="Resume and job description matching preview">
            <div className="relative overflow-hidden border border-[#D8D0C2] bg-[#FFFDF8] p-5 shadow-[12px_12px_0_#D8D0C2] sm:p-7">
              ...
              <div className="mt-6 grid gap-5 sm:grid-cols-[1fr_auto]">
                <div className="space-y-4"><div><div className="h-3 w-32 bg-[#18232B]" /><div className="mt-2 h-2 w-48 bg-[#D8D0C2]" /></div><div className="space-y-2"><div className="h-2 w-full bg-[#E5DED3]" /><div className="h-2 w-11/12 bg-[#E5DED3]" /><div className="h-2 w-4/5 bg-[#E5DED3]" /></div><div className="flex flex-wrap gap-2 pt-1">{["Python", "REST APIs", "PostgreSQL"].map((keyword) => <span key={keyword} className="border border-[#2F7770]/30 bg-[#2F7770]/10 px-2 py-1 font-mono text-[11px] text-[#2F7770]">{keyword}</span>)}</div></div>
                <div className="flex flex-col items-end justify-between border-l border-[#D8D0C2] pl-5"><ScanLine className="h-7 w-7 text-[#2F7770]" /><div className="text-right"><div className="font-serif text-4xl font-bold text-[#2F7770]">78</div><div className="font-mono text-[10px] uppercase tracking-[0.12em] text-[#7A8580]">match score</div></div></div>
              </div>
